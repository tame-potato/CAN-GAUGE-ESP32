...
static esp_err_t panel_ssd1306_init(esp_lcd_panel_t *panel)
{
    ...
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0xae, NULL, 0), TAG, "io tx param SSD1306_CMD_DISP_OFF failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0xa4, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0xd5, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0x50, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0xa8, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0x3f, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0xd3, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0x00, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0x40, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0xad, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0x8b, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0xd9, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0x22, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0xdb, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0x35, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0x32, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0x81, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0xff, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0xa6, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0xda, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, 0x12, NULL, 0), TAG, "io tx param SSD1306_CMD_SET_MEMORY_ADDR_MODE failed");
